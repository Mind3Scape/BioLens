...
export const MARKERS = {
  ...
  glucose: { t:'Глюкоза', g:'sugar', unit:'ммоль/л', conv:{'mmol/l':1,'ммоль/л':1,'mg/dl':1/18.0182,'мг/дл':1/18.0182},
    ...
    grades:[{to:5.6,label:'норма'},{to:7,label:'зона преддиабета'},{label:'уровень диабета, нужен повтор и врач'}],
  ...
  hba1c: { t:'Гликированный гемоглобин', g:'sugar', unit:'%', conv:{}, ref:[4,6],
    ...
    grades:[{to:5.7,label:'норма'},{to:6.5,label:'зона преддиабета'},{label:'уровень диабета, нужен повтор и врач'}],
  ...
  ldl: { t:'Холестерин ЛПНП', g:'lipids', unit:'ммоль/л',
    ...
    grades:[{to:1.4,label:'цель при очень высоком риске'},{to:1.8,label:'цель при высоком риске'},{to:2.6,label:'цель при умеренном риске'},{to:3,label:'приемлемо при низком риске'},{label:'выше желаемого'}],
